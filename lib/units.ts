/**
 * Single source of truth for the three sibling vacation rentals.
...
export const units: Unit[] = [
  ...
  },
  {
    ...
    amenities: [
      ...
      'Private garage plus free street parking directly outside',
      'Northern Lights viewing from the upper-level deck (late August through April)',
      'Beach access nearby (steps to the Tony Knowles Coastal Trail)',
      'Self-check-in via keypad',
    ],
  ...
  },
  {
    ...
    amenities: [
      ...
      'Northern Lights viewing from the private patio (late August through April)',
